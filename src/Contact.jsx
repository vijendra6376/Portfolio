...
const Contact = () => {
  return (
    <div name='contact' className='bg-gradient-to-r from-[#0F0C29] to-[#302B63] text-gray-300 w-full min-h-screen flex justify-center items-center p-4'>
      <form method='POST' action="https://getform.io/f/YerJRLeO" className='flex flex-col max-w-[600px] w-full'>
        ...
        <button className='border-2 hover:bg-pink-600 hover:border-pink-600 hover:scale-95 px-4 py-3 my-8 mx-auto items-center rounded-lg'>Let's Connect!</button>
      </form>
    </div>
  )
}
