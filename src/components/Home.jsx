...
const Home = () => {
  ...
  return (
    <div name='home' className='relative w-full h-screen bg-gradient-to-r animate-move-gradient from-[#0F0C29] to-[#302B63] text-gray-300 md:px-10 max-sm:px-6 overflow-hidden'>  
