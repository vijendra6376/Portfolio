  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-gradient-to-r from-[#1C1B2E] to-[#302B63] text-gray-300'>
      ...
      <div onClick={handleClick} className='md:hidden z-10'>
        ...
        {/*Mobile Menu */}
        <ul className={!nav ? 'hidden' : 'absolute top-0 right-0 w-75% h-75% opacity-90 rounded-xl font-bold font-mono m-auto bg-slate-900  text-gray-300 flex flex-col justify-center items-center'}>
      ...
      <div className='flex fixed flex-col top-[35%] left-0'>
        <ul>
            ...
            <li className='w-[80px] md:w-[142px] lg:w-[160px] h-[30px] lg:h-[40px] rounded-lg flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f69]'>
                <a className='flex justify-between items-center w-full text-gray-300'
                href="https://drive.google.com/file/d/1NSlzhW6n875aoZqa9u3z__TIlHZ5Bcd6/view?usp=sharing" target='blank'>Resume<BsFillPersonLinesFill size={30} className='mr-[-10px] lg:mr-0 duration-300'/>
                </a>
            </li>
        </ul>
      </div>
